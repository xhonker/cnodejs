...
import { setScroll } from "../../../actions/index";
...
class TopicList extends Component {
  ...
  componentWillUnmount() {
    ...
    let scrollTop = ReactDOM.findDOMNode(this.refs.listDiv).scrollTop;
  ...
  render() {
    ...
    return (
      <div
        style={{
          height: document.documentElement.clientHeight - 276,
          overflow: "auto"
        }}
        onScroll={() =>
          onScrolls(
            ReactDOM.findDOMNode(this.refs.listDiv),
            ReactDOM.findDOMNode(this.refs.listItem)
          )}
        ref="listDiv"
      >
        <List ref="listItem">
